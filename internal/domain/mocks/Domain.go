...
// Verify provides a mock function with given fields: ctx, user
func (_m *Domain) Verify(ctx context.Context, user types.User) (bool, error) {
	ret := _m.Called(ctx, user)
...
// Domain_Verify_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Verify'
type Domain_Verify_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - user types.User
func (_e *Domain_Expecter) Verify(ctx interface{}, user interface{}) *Domain_Verify_Call {
	return &Domain_Verify_Call{Call: _e.mock.On("Verify", ctx, user)}
}

func (_c *Domain_Verify_Call) Run(run func(ctx context.Context, user types.User)) *Domain_Verify_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.User))
	})
	return _c
...
func (_c *Domain_Verify_Call) Return(verified bool, err error) *Domain_Verify_Call {
	_c.Call.Return(verified, err)
	return _c
}

func (_c *Domain_Verify_Call) RunAndReturn(run func(context.Context, types.User) (bool, error)) *Domain_Verify_Call {
	_c.Call.Return(run)
	return _c
}
