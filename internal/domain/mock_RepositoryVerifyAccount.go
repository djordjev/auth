...
func (_m *MockRepositoryVerifyAccount) Create(token string, userId uint) (VerifyAccount, error) {
	ret := _m.Called(token, userId)

	var r0 VerifyAccount
	var r1 error
	if rf, ok := ret.Get(0).(func(string, uint) (VerifyAccount, error)); ok {
		return rf(token, userId)
	}
	if rf, ok := ret.Get(0).(func(string, uint) VerifyAccount); ok {
		r0 = rf(token, userId)
	} else {
...
func (_c *MockRepositoryVerifyAccount_Create_Call) Run(run func(token string, userId uint)) *MockRepositoryVerifyAccount_Create_Call {
...
func (_c *MockRepositoryVerifyAccount_Create_Call) RunAndReturn(run func(string, uint) (VerifyAccount, error)) *MockRepositoryVerifyAccount_Create_Call {
	_c.Call.Return(run)
	return _c
}
